...
//            }
    ...
    private void checkEndTile() {
        int playerLocationX = Game.player1.getLocationX();
        int playerLocationY = Game.player1.getLocationY();
...
//        System.out.println(levelLoader.getNumberOfLevels());
    ...
    protected void loadTestLevel() {
        LevelGetter levelLoader = new LevelGetter();
//        System.out.println(levelLoader.getNumberOfLevels());
        Game.mazeMap = levelLoader.loadMapToArray(0);
        Game.player1 = levelLoader.loadPlayer();
    }
    ...
    public void tryPlayerMove(int keyPressedCode) {
        ...
        if (canWalk) {
            GameElement standingObject = Game.mazeMap[nextItemLocationY][nextItemLocationX].getStandingObject();
            ...
            if (standingObject instanceof Barricade) {
                ...
                if (walkingAgainstBarricade == null) {
                    Game.mazeMap[nextItemLocationY][nextItemLocationX].setStandingObject(walkingAgainstBarricade);
                    Game.player1.move(moveDirection);
                }
                ...
                Game.mazeMap[nextItemLocationY][nextItemLocationX].setStandingObject(walkingAgainstKey);
                Game.player1.move(moveDirection);
